        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-mono text-gray-400 uppercase tracking-wider">App</span>
              <Dot ok={true} />
            </div>
            <p className="text-white font-semibold mb-1">AMD Price Tracker</p>
            <p className="text-gray-400 text-sm mb-4">Scraping CA prices · 2× daily</p>
          ...
          <div className="bg-[#0f1419] border border-white/5 rounded-xl p-5">
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-mono text-gray-400 uppercase tracking-wider">Server</span>
              <Dot ok={!!data?.stats} />
            </div>
            {loading ? (
          ...
          <div className="bg-[#0f1419] border border-white/5 rounded-xl p-5">
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-mono text-gray-400 uppercase tracking-wider">Services</span>
              <Dot ok={true} />
            </div>
            ...
            <p className="text-gray-400 text-xs mb-4">Running 24/7 on paisbru.com</p>
            <div className="flex flex-wrap gap-1.5">
              {["nginx", "PostgreSQL", "MongoDB", "Redis", "Cloudflare"].map((s) => (
                <span key={s} className="text-xs text-gray-400 bg-white/5 px-2 py-0.5 rounded">
                  {s}
                </span>
              ))}
            </div>
